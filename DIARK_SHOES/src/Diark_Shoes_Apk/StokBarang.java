...
public final class StokBarang extends javax.swing.JFrame {
    ...
    try {
        ...
        pst.setString(1, jTextField2.getText());  // Mengambil kode barang dari input
        rst = pst.executeQuery();
        rst.next();
        int count = rst.getInt(1);

        if (count > 0) {
            // Jika kode barang sudah ada, tampilkan pesan tanpa menghapus input lainnya
            JOptionPane.showMessageDialog(null, "Kode barang sudah ada. Silakan masukkan kode barang lain.");
        } else {
            // Jika kode barang belum ada, simpan data
            ...
            pst.setString(3, jTextField3.getText());  // Stok
            pst.setString(4, jTextField5.getText());  // Tipe
            pst.setString(5, jTextField4.getText());  // Harga
            pst.execute();
            JOptionPane.showMessageDialog(null, "Data Tersimpan");
            update_tabel();  // Update tabel setelah menyimpan data
        }
